...
import static org.rapidpm.vaadin.server.LoginHtmlServlet.*;
...
public class LoginHtmlServlet extends HttpServlet {
  ...
  private void serveLoginHtml(HttpServletRequest request, HttpServletResponse response) {
    ...
    match(
        ...
        .ifPresentOrElse(success -> ((CheckedFunction<String, InputStream>) LoginHtmlServlet.class::getResourceAsStream)
                             .apply(success)
                             .ifPresentOrElse(
